...
async function main( params ) {
    try {
        ...
        await contract.submitTransaction('changeAll', `${ key }`, `${ address }`, `${ city }`, `${ property_size }`, `${ owner_name }`, `${ property_type }`);
        console.log('Change Property details Transaction has been submitted');
